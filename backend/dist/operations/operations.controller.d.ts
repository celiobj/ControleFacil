...
export declare class OperationsController {
    ...
    renovations(propertyId?: string): import(".prisma/client").Prisma.PrismaPromise<{
        id: string;
        description: string;
    ...
    renovation(body: any): import(".prisma/client").Prisma.Prisma__RenovationClient<{
        id: string;
        description: string;
        status: import(".prisma/client").$Enums.RenovationStatus;
        propertyId: string;
